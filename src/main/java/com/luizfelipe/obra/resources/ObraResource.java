...
public class ObraResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ObraDTO> update(@PathVariable Long id, @Valid @RequestBody ObraDTO objDTO) {
		Obra newObj = obraService.update(id, objDTO);
		return ResponseEntity.ok().body(new ObraDTO(newObj));
	}
